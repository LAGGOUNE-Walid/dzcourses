...
<head>
    ...
    <title>Dz-courses Sign up for teachers</title>
...
<body style="font-family: Arvo, serif;">
    ...
    <div class="text-center" style="opacity: 0.50;padding-top: 10%;">
        <h1 style="padding-top: 10%;font-size: 56px;">Sign up as teacher&nbsp;</h1>
    </div>
    ...
    <? if(isset($errors)): ?>
        <div class="alert alert-danger" role="alert" style="background-color: rgb(190,136,141);"><span><? foreach($errors as $input => $error): ?>
            ...
            <? endforeach; ?></span></div>
    <? endif; ?>
    <form method="POST" action="<? echo $this->url('postTeacherSignup'); ?>" enctype='multipart/form-data'
        ><input type="hidden" name="_token" value="<? echo $token; ?>">
        <label>First name</label><input class="form-control" type="text" name="firstname" required="" autofocus="" style="margin-bottom: 2%;">
        <label>Last name</label><input class="form-control" type="text" name="lastname" required="" autofocus="" style="margin-bottom: 2%;">
        <label>Email</label><input class="form-control" type="text" name="email" required="" autofocus="" inputmode="email" style="margin-bottom: 2%;">
        <label>Address<br></label><input class="form-control" type="text" name="address" required="" autofocus="" style="margin-bottom: 2%;">
        ...
        <label>Photo&nbsp;<br></label><input type="file" accept="image/*" name="photo" required="" style="margin-bottom: 2%;width: 100%;">
        <label>Description of you<br></label><textarea class="form-control" name="description" autofocus="" style="margin-bottom: 2%;"></textarea>
        <label>CCP number<br></label><input class="form-control" type="text" name="ccp" required="" autofocus="" style="margin-bottom: 2%;">
        <label>CCP key<br></label><input class="form-control" type="text" name="key" required="" autofocus="" style="margin-bottom: 2%;">
        <label>Password<br></label><input class="form-control" type="password" name="password" autofocus="" style="margin-bottom: 2%;">
