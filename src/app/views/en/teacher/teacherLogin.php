...
<head>
    ...
    <title>Dz-courses Login for teachers</title>
...
<body style="font-family: Arvo, serif;">
    ...
    <div class="text-center" style="opacity: 0.50;padding-top: 10%;">
        <h1 style="padding-top: 10%;font-size: 56px;">Login as teacher&nbsp;</h1>
    </div>
    ...
    <? endif; ?>
        <form method="POST" action="<? echo $this->url('postTeacherLogin'); ?>"><input type="hidden" name="_token" value="<? echo $token; ?>"><label>Email</label>
            <input
                class="form-control" type="text" name="email" required="" autofocus="" inputmode="email" style="margin-bottom: 2%;">
                <label>Phone number <br></label><input class="form-control" type="tel" name="phone" required=""
                    autofocus="" style="margin-bottom: 2%;">
                    <label>Password<br></label><input class="form-control" type="password" name="password" autofocus="" style="margin-bottom: 2%;"><button class="btn btn-primary" type="submit">Go</button></form>
    </div>
