...
<html lang="en">
  <head>
    <title>Dz &mdash; courses - Learner signup</title>
  ...
  <div class="site-wrap">
    ...
    <div class="site-section bg-light">
      <div class="container">
        <div class="row">
          <div style="width: 100%; max-width: 100%; margin-left: 10%; margin-right: 10%;">
            <form  method="POST" action="<? echo $this->url('postLearnerSignup'); ?>" class="p-5 bg-white" enctype='multipart/form-data'>
            <? if(isset($errors)): ?>
      ...
      <h5 class="card-header" style=" color: white; background: #757575; ">For the online learners :</h5>
      <div class="card-body">
      <strong>You must to read this  <a href="<? echo $this->url('terms'); ?>">Terms of use</a> Chapter 3</strong>
      </div>
</div>
             <input type="hidden" name="_token" value="<? echo $token; ?>">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="description" id="description" cols="30" rows="7" class="form-control" placeholder="Write your description here..." required="true"></textarea>
                </div>
              </div>
              <div class="row form-group">
                  <div class="col-md-12">                   
                ...
                <div class="row form-group">
                  ...
                  <select name="plan">
                    <option value="1">1000Da = 1 cours per month</option>
                    <option value="2">1500Da = 2 courses per month</option>
                    <option value="3">2000Da = 3 courses per month</option>
                  </select>
</div>
              <div class="row form-group">
                <div class="col-md-12">
