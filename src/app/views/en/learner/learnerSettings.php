            ...
            <div class="row align-items-center">
              <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item">
                    <a href="<? echo $this->url('lSettings'); ?>" class="nav-link active"><i class="fe fe-settings"></i>Settings</a>
                  </li>
                  <li class="nav-item">
                    <? if($messages == 0): ?>
        ...
        <br/>
          ...
          <? if(isset($suc)): ?>
            <div class="alert alert-success" role="alert">
             - <? echo $suc ?> !
             <small>Click <a href="<? echo $this->url('lSettings'); ?>">here</a> to see updates </small>
            </div>
          <? endif; ?>
