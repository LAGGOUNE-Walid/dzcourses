...
<head>
    ...
    <title>Dz-courses Login for learners</title>
...
<body style="font-family: Arvo, serif;">
    ...
    <div class="text-center" style="opacity: 0.50;padding-top: 10%;">
        <h1 style="padding-top: 10%;font-size: 56px;">Login as learner&nbsp;</h1>
    </div>
    ...
    <? endif; ?>
        <form method="POST" action="<? echo $this->url('postLearnerLogin'); ?>"><input type="hidden" name="_token" value="<? echo $token; ?>"><label>Email</label>
            <input
