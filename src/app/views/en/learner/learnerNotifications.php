            ...
            <div class="row align-items-center">
              <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item">
                    <? if($count == 0): ?>
                      <a href="<? echo $this->url('lNotifications/1'); ?>" class="nav-link active" id="notf"><i class="fe fe-bell"></i>Notifications&nbsp;<strong>(<span id="notfNumber"> 0 </span>)</strong></a>
                    <? else: ?>
                    <a href="<? echo $this->url('lNotifications/1'); ?>" class="nav-link active" id="msg" style="color:green;"><i class="fe fe-bell"></i>Notifications&nbsp;<strong>(<span id="msgNumber"><? echo $count; ?></span>)</strong></a>
                    <?endif;?>  
                  </li>
                  <li class="nav-item">
