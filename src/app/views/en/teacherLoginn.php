...
<html lang="en">
  <head>
    <title>Dz &mdash; courses - Teacher login</title>
        ...
        Swal.fire({
            ...
            html:
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block mb-0">
                ...
                <li><span><a href="#" style="color: black;" onclick="redirect()">Join</a></span></li>
                <li  class="active"><span><a href="#" onclick="redirectS()">Login</a></span></li>
      ...
      <div class="container">
        <div class="row">
          <div style="width: 100%; max-width: 100%; margin-left: 10%; margin-right: 10%;">
            <form  method="POST" action="<? echo $this->url('postTeacherLogin'); ?>" class="p-5 bg-white" enctype='multipart/form-data'>
            <? if(isset($errors)): ?>
        ...
        <? endif; ?>
             <input type="hidden" name="_token" value="<? echo $token; ?>">
              ...
              <div class="row form-group">
                  ...
                  <input type="tel" name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{2}-[0-9]{2}-[0-9]{2}" required="true" id="Phone" class="form-control" value="Pattern : 213-xxx-xx-xx-xx" name="phone">
                  </div>
                </div>
                <div class="row form-group">
                  <div class="col-md-12">                   
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input size="max-width:10%;" type="submit" value="Login " class="btn btn-primary py-2 px-4 text-white">
                </div>
              </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-4">
            ...
            <p>Our mission is to improve the Algerian web . we believe that the knowledge is a powerful weapon so we created Dz-courses for getting it and other skills closer to you .</p>
            <br/>
