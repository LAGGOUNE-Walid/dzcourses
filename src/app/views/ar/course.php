...
<body style="font-family: 'sky-bold';">
    ...
    <div style="direction: rtl; padding-top: 7%;margin-right: 5%;margin-left: 5%;">
        <img style="width: 100%;" src="../<?php echo $course->cover;  ?>" class="img-fluid" alt="">
        <div style="direction: rtl; padding-top: 5%;opacity: 0.50;">
            ...
            <h1>ماذا سوف تتعلم من هذه الدورة</h1>
            <p style="padding-bottom: 5%;"><? echo strip_tags($course->skillsToGain); ?>&nbsp;<br></p>
            <h1>الإحصائيات</h1>
            <p>&nbsp;- <? echo $courseTakes; ?> مُتَعلِم .<br>- التقييم : <? echo $rate; ?>/10 | <a href="<? echo $this->url('rate').'/'.(string)$course->_id; ?>">المزيد من المعلومات</a> .<br>- عدد مقاطع الفيديو : <? echo $course->videosNumber; ?>.&nbsp;<br>- المدة : <? echo round($courseTime / 60); ?>دقيقة.</p>
            <h1 style="padding-top: 5%;">المدرب</h1>
        </div>
            ...
            <div class="col" style="padding:0px;">
                <div class="card">
                    <div class="card-body" style="height:50vh;">
                        ...
                        <p class="card-text" style="opacity: 0.50;"><? echo strip_tags($user->description); ?></p><a class="card-link" href="<? echo $this->url('p').'/'.$course->user_id; ?>" style="opacity: 0.50;color: rgb(0,0,0);">الملف الشخصي</a>
                        <a
                            class="card-link" href="<? echo $this->url('message')."/".$course->user_id; ?>" style="opacity: 0.50;color: rgb(0,0,0);">أرسل رسالة</a>
                    </div>
                </div>
            </div>
        </div><a href="<? echo $this->url('watch')."/".str_replace(' ', '-', $course->title)."/1"; ?>"><button class="btn btn-light btn-lg" type="button" id="enroll" style="margin-top: 7%;margin-right: 45%;margin-left: 45%;background-color: rgb(255,255,255);color: rgb(0,0,0); border: 1px solid black;">مشاهدة</button></a>
        <div style="border:1px solid red; margin-top: 5%; opacity: 0.50;" class="alert alert-danger" role="alert">
            <strong style="direction: rtl;">يمكنك مشاهدة مقاطع الفيديو الأولى والثانية من أي دورة مجانًا.<strong>
</div></div>
