...
<head>
    ...
    <title>Dz-courses التسجيل كمتَعلم</title>
...
<body style="font-family: 'sky-bold';">
    ...
    <div class="text-center" style="opacity: 0.50;padding-top: 10%;">
        <h1 style="padding-top: 10%;font-size: 56px;">التسجيل كمٌتعلِم&nbsp;</h1>
    </div>
    ...
    <? if(isset($errors)): ?>
        <div class="alert alert-danger" role="alert" style="background-color: rgb(190,136,141);"><span><? foreach($errors as $input => $error): ?>
            ...
            <? endforeach; ?></span></div>
    <? endif; ?>
        <form style="direction: rtl;" method="POST" action="<? echo $this->url('postLearnerSignup'); ?>" enctype='multipart/form-data'>
            <input type="hidden" name="_token" value="<? echo $token; ?>">
            <label style="float: right;">اللقب</label>
            <input class="form-control" type="text" name="firstname" required="" autofocus="" style="margin-bottom: 2%;">
            <label style="float: right;">الإسم</label>
            <input class="form-control" type="text" name="lastname" required="" autofocus="" style="margin-bottom: 2%;"><label style="float: right;">الإيميل</label>
            <input
                class="form-control" type="text" name="email" required="" autofocus="" inputmode="email" style="margin-bottom: 2%;"><label style="float: right;">عنون السكن<br></label><input class="form-control" type="text" name="address" required="" autofocus="" style="margin-bottom: 2%;">
                <label style="float: right;">رقم الهاتف</label><input class="form-control" type="tel" name="phone" placeholder="رقم الهاتف" required="" autofocus="" style="margin-bottom: 2%;">
                    <label style="float: right;">الصورة&nbsp;<br></label><input type="file" accept="image/*" name="photo" required="" style="margin-bottom: 2%;width: 100%;"><label style="float: right;">وصف قصير عنك<br></label><textarea class="form-control"
                    name="description" autofocus="" style="margin-bottom: 2%;"></textarea>
                    <label class="text-black" for="Address">الخطط</label>                    
                  <select name="plan">
                    <option value="1">500da</option>
                    <option value="2">900da</option>
                    <option value="3">1300da</option>
                  </select>
                  <br/><label style="float: right;">كلمة السر<br></label><input class="form-control" type="password" name="password" autofocus="" style="margin-bottom: 2%;"><button class="btn btn-primary" type="submit">سجل</button></form>
    </div>
