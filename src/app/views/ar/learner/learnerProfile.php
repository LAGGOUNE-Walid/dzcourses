<? $page = "account"; require "learnerArabicPanel.php"; ?>
          <body class="">
                  ...
                  <div class="card-header" style="background-image: url(src/app/views/images/student.jpg); height: 300px;" ></div>
                    ...
                    <p class="mb-4">
                      ...
                      <ul style="list-style-type: none;  margin: 0; padding: 0;overflow: hidden;">
                        ...
                        <li><small>عنوان السكن : <? echo $user->address; ?> </small></li>
                        ...
                        <li><small>الدورات المسجلة : <? echo $courses; ?> </small></li>
                        <li>
                    ...
                    <center>
                      <div class="col-md-10">
                        <div class="form-group">
                          <label class="form-label">رابط المشاركة <button class="btn btn-primary" onclick="copy()">نسخ <i class="fa fa-copy"></i></button>  </label>
