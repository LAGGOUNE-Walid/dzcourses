<? $page = "messages"; require "learnerArabicPanel.php"; ?>
    ...
    <div class="page">
      <div class="page-main">
        <div class="header py-8">
          <div class="container">
            <? if($allMsgsCount !== 0): ?>
              <span style="float: right;" class="badge badge-primary">الكُل : <? echo $allMsgsCount; ?></span>
              <div class="col-lg-16" style=" padding:5%;"> 
              <div style="display: none;" id="success-alert">
                <button type='button' class='btn btn-primary' id="clear">مسح الكل</button><br/><br/>
              </div>
              <div id="messages">
              </div>
