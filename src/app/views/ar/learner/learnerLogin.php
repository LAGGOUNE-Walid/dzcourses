...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="src/app/views/images/logo2.jpg"/>
     <title>Dz-courses تسجيل الدخول كمتعلم</title>
...
<body style="font-family: 'sky-bold';">
    ...
    <div class="text-center" style="opacity: 0.50;padding-top: 10%;">
        <h1 style="padding-top: 10%;font-size: 56px;">تسجيل الدخول كمتَعلم&nbsp;</h1>
    </div>
    ...
    <? endif; ?>
        <form method="POST" action="<? echo $this->url('postLearnerLogin'); ?>"><input type="hidden" name="_token" value="<? echo $token; ?>"><label style="float: right;">الإيميل</label>
            <input
                class="form-control" type="text" name="email" required="" autofocus="" inputmode="email" style="margin-bottom: 2%;"><label style="float: right;">رقم الهاتف</label><input class="form-control" type="tel" name="phone" required="" autofocus="" style="margin-bottom: 2%;"><label style="float: right;">كلمة السر<br></label><input class="form-control" type="password" name="password" autofocus="" style="margin-bottom: 2%;"><button class="btn btn-primary" type="submit">دخول</button></form>
    </div>
